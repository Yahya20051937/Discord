...
public class RabbitConfig {
    public static String ROOM_ROLE_EXCHANGE = "ROOM-ROLE-EXCHANGE";

    public static String ROOM_ROLE_QUEUE = "ROOM-ROLE-QUEUE";

    public static String ROOM_ROLE_ROUTING_KEY = "ROOM-ROLE.ROUTING.KEY";
    ...
    @Bean
    Queue queue(){
        return new Queue(ROOM_ROLE_QUEUE, true);
    }

    @Bean
    DirectExchange directExchange(){
        return new DirectExchange(ROOM_ROLE_EXCHANGE);
    }
