...
public class ServerNotificationService {
    ...
    public void notifyMessageSent(String username, String roomId,String roomPackageId, String serverId){
        // this will be used to increment the number of unread messages in the rooms composable except for the room that the client is connected to.
        try {
            this.notifyServer(
                    Map.of(
